  ...
  return (
    <div className=' food-item w-[100%] m-auto rounded-2xl'>
      <div className='relative'>
        ...
        {!cartitem[id]
          ? <img  onChange={(e)=> setCount(e.target.value)} onClick={() => addToCart(id)} src={assets.add_icon_white} alt="" className='w-[34px] absolute bottom-4 right-4 cursor-pointer rounded-full' />
