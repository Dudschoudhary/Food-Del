...
const PlaceOrder = () => {
  ...
  return (
    <form className='place-order sm:flex sm:items-start sm:justify-between gap-12 mt-[100px]'>
      ...
      <div className="place-order-right w-full max-w-[max(40%,500px)] mt-[100px]">
        <div className="cart-total flex-1 flex flex-col gap-5">
          ...
          <button className='border-none flex justify-center items-center w-full text-white bg-[#ff6347] sm:w-[max(15vw,200px)] py-3 rounded cursor-pointer mt-7'>PROSRRD TO PAYMENT</button>
        </div>
